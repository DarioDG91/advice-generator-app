...
function App() {
  ...
  const paragraphClasses = `text-2xl text-lightCyan tracking-[-0.01em] sm:text-[1.7rem] sm:tracking-normal sm:leading-9 sm:mb-4`;
    ...
    <>
      <main className=" flex flex-col items-center bg-darkGrayishBlue text-center px-6 py-10 rounded-lg relative sm:py-[3.2rem] sm:px-12 sm:rounded-2xl">
        ...
        <p className={paragraphClasses}>
          {!isLoading ? advice.advice : <Circles color="hsl(150, 100%, 66%)" />}
        </p>
        <div className="py-6 ">
